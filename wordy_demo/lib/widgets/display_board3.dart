...
import 'package:wordy_demo/widgets/display_letter3.dart';
import 'package:wordy_demo/widgets/grey_box.dart';

import '../models/general_model.dart';

class DisplayBoard3 extends StatelessWidget {
  final String wordToFind;
  final int boardId;
  const DisplayBoard3({Key? key,required this.wordToFind,required
                  ...
                  children: [
                    ...
                    IgnorePointer(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: keyBoardModel.wordLetters3.map((letter) => DisplayLetter3(letter: letter))
                            .toList(),
                      ),
                    ),
