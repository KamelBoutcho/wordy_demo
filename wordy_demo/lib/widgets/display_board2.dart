...
import 'package:wordy_demo/widgets/display_letter2.dart';
import 'package:wordy_demo/widgets/grey_box.dart';

import '../models/general_model.dart';

class DisplayBoard2 extends StatelessWidget {
  final String wordToFind;
  final int boardId;
  const DisplayBoard2({Key? key,required this.wordToFind,required
                  ...
                  children: [
                    ...
                    IgnorePointer(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: keyBoardModel.wordLetters2.map((letter) => DisplayLetter2(letter: letter))
                            .toList(),
                      ),
                    ),
